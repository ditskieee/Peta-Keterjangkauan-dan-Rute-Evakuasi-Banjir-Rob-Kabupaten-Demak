...
map.getView().fit([12273158.806671, -791974.373637, 12336442.938540, -754325.133764], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Keterjangkauan dan Rute Evakuasi Banjir Rob Kabupaten Demak</h2>';
        return titleElement;
    })(),
